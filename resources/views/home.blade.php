...
<body>
    ...
    <div class="hero fade-in blur">
        <div class="carousel-hero">
            <img src="{{ asset('img/img1hero.JPG') }}" alt="Image 1">
            <img src="{{ asset('img/img2hero.jpg') }}" alt="Image 2">
            <img src="{{ asset('img/img3hero.jpg') }}" alt="Image 3">
        </div>
    ...
    <div class="shoemaking fade-in blur">
        <img class="shoemaking-img" src="{{ asset('img/img1history.jpg') }}">
        <img class="shoemaking-img" src="{{ asset('img/img2history.jpg') }}">
    </div>
    ...
    <div class="products fade-in blur">
            ...
            <div class="products-container">
                <div class="product">
                    <a href ="Products/officer-shoe/produk11.html">
                        <img class="featured-img" src="{{ asset('img/img1featured.jpg') }}">    
                    </a>
                    <a href="Products/officer-shoe/produk11.html">
                ...
                <div class="product">
                    <a href="Products/legetant/produk7.html">
                        <img class="featured-img" src="{{ asset('img/img2featured.jpg') }}">    
                    </a>
                    <a href="Products/legetant/produk7.html">
                ...
                <div class="product">
                    <a href="Products/Marine-dress-boots/produk9.html">
                        <img class="featured-img" src="{{ asset('img/img3featured.jpg') }}">    
                    </a>
                    <a href="Products/Marine-dress-boots/produk9.html">
        ...
        <div class="products-carousel">
            ...
            <div class="multi-carousel">
                <a href="Products/liberty-boots/produk8.html" class="product-img"><img src="{{ asset('img/img1.jpg') }}"></a>
                <a href="Products/cordmaster-shoe/produk4.html" class="product-img"><img src="{{ asset('img/img2.jpg') }}"></a>
                <a href="Products/regent-boots/produk12.html" class="product-img"><img src="{{ asset('img/img3.jpg') }}"></a>
                <a href="Products/Sylt-Pump-In-Black-Brushed-Leather/produk13.html" class="product-img"><img src="{{ asset('img/img4.jpg') }}"></a>
                <a href="Products/Sylt-Slingback-Pump-In-Light-Beige-Nappa-Leather/produk19.html" class="product-img"><img src="{{ asset('img/img5.jpg') }}"></a>
                <a href="Products/Ballyrina-Mary-Jane-Pump-In-Black-Leather/produk17.html" class="product-img"><img src="{{ asset('img/img6.jpg') }}"></a>
                <a href="Products/Kerbs-Driver-In-White-Leather/produk22.html" class="product-img"><img src="{{ asset('img/img7.jpg') }}"></a>
                <a href="Products/Ballyrina-Flat-In-Black-Leather/produk23.html" class="product-img"><img src="{{ asset('img/img8.jpg') }}"></a>
            </div>
    ...
    <div class="ip fade-in blur">
        <div class="row-ip">
            <div class="img-ip-container">
                <img class="img-ip" src="{{ asset('img/ip_img1.jpg') }}">
                <div class="img-ip-text">
                    <h3>QUALITY</h3>
                </div>
            </div>
            <div class="img-ip-container">
                <img class="img-ip" src="{{ asset('img/ip_img2.jpg') }}">
                <div class="img-ip-text">
                    <h3>COMFORT</h3>
                </div> 
            </div>
        ...
        <div class="row-ip">
            <div class="img-ip-container">
                <img class="img-ip" id="img-ip-spesific" src="{{ asset('img/ip_img3.jpg') }}">
                <div class="img-ip-text" id="spesific-img-text">
                    <h3>STYLE</h3>
                </div> 
            </div>
            <div class="img-ip-container">
                <img class="img-ip" src="{{ asset('img/ip_img4.jpg') }}"> 
                <div class="img-ip-text">
                    <h3>ELEGANCE</h3>
                </div>
            </div>
